...
$BLENDER_BIN $BLENDER_PROJ_PATH --background --python draft/tsdf_graspdetection.py

# $BLENDER_BIN $BLENDER_PROJ_PATH --background --python scripts/TM_grasp_withoutGUI.py -- $MODEL
