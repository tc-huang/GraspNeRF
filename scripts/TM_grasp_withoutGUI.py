...
# import pip
# pip.main(['install', 'pyserial', 'serial', '--user'])
...
# TODO:JH
CALIBRATION_PARAMS_SAVE_DIR = Path(__file__).parent.parent# / "calibration_params/2024_03_06" #有筆
### 
...
class PandaGraspController():
    def __init__(self, model):
        ...
        self.plan_grasps = VGN(model, rviz=True)
...
def main(model):
    ...
    panda_grasp = PandaGraspController(model)

    ### TODO: tc-huang
    with open(str(CALIBRATION_PARAMS_SAVE_DIR / 'calibration_params_0.json')) as f:
...
if __name__ == "__main__":
    ...
    # args['model'] = "/home/eric/catkin_ws/src/vgn/scripts/data/models/vgn_conv.pth"
    model = Path("/catkin_ws/GraspNeRF/src/nr/ckpt/test/model_best.pth")
    main(model)
