...
class GraspNeRFPlanner(object):
    ...
    def core(self, 
        ...
        """
        # np.save('new_sim_images.npy', images)
        # np.save('new_sim_extrinsics.npy', extrinsics)
        # np.save('new_sim_intrinsics.npy', intrinsics)
        # np.save('new_sim_depth_range.npy', depth_range)
        # np.save('new_sim_bbox3d.npy', bbox3d)
        ...
        # np.save('new_sim_volume.npy', render_info['volume'])
        # sys.exit(0)
